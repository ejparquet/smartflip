...
const mockElectricalLicenses: License[] = [
  {
    id: "1",
    type: "master_electrician",
    name: "Master Electrician License",
    licenseNumber: "ME-2024-45892",
    issuingAuthority: "Texas Department of Licensing & Regulation",
    state: "TX",
    issueDate: "2019-06-15",
    expirationDate: "2025-06-15",
    status: "active",
    renewalReminder: true,
    ceCreditsRequired: 32,
    ceCreditsCompleted: 24,
    notes: "Primary license for all electrical work in Texas",
  },
  {
    id: "2",
    type: "journeyman_electrician",
    name: "Journeyman Electrician License",
    licenseNumber: "JE-2017-33201",
    issuingAuthority: "Texas Department of Licensing & Regulation",
    state: "TX",
    ...
    ceCreditsCompleted: 24,
    notes: "Upgrade to Master obtained - maintain for reference",
  },
  {
    id: "3",
    type: "low_voltage",
    name: "Low Voltage Technician License",
    licenseNumber: "LV-2022-78541",
    issuingAuthority: "Texas Department of Licensing & Regulation",
    state: "TX",
    ...
    status: "active",
    renewalReminder: true,
    notes: "For alarm systems, data cabling, and security installations",
  },
  {
    id: "4",
    type: "fire_alarm",
    name: "Fire Alarm Installation License",
    licenseNumber: "FA-2023-12458",
    issuingAuthority: "State Fire Marshal's Office",
    state: "TX",
    ...
    ceCreditsCompleted: 8,
  },
  {
    id: "5",
    type: "osha",
    name: "OSHA 30-Hour Construction",
    licenseNumber: "OSHA-30-784521",
  ...
  },
  {
    ...
    name: "Electrical Sign License",
    licenseNumber: "ES-2024-55892",
    issuingAuthority: "Texas Department of Licensing & Regulation",
    state: "TX",
...
const mockElectricalCE: ContinuingEducation[] = [
  {
    id: "1",
    licenseId: "1",
    courseName: "2024 NEC Code Changes",
  ...
  },
  {
    id: "2",
    licenseId: "1",
    courseName: "Arc Flash Safety & NFPA 70E",
  ...
  },
  {
    id: "3",
    licenseId: "1",
    courseName: "Solar PV Installation Best Practices",
    provider: "NABCEP",
  ...
  },
  {
    id: "4",
    licenseId: "1",
    courseName: "Grounding & Bonding Fundamentals",
  ...
  },
  {
    id: "5",
    licenseId: "4",
    courseName: "NFPA 72 Fire Alarm Code Update",
    provider: "NFPA Training",
...
const electricalTypeConfig: Record<string, { label: string; icon: any; color: string }> = {
  master_electrician: { label: "Master Electrician", icon: Award, color: "#EAB308" },
  journeyman_electrician: { label: "Journeyman", icon: Award, color: "#3B82F6" },
  electrician_license: { label: "Electrician", icon: Zap, color: "#8B5CF6" },
  low_voltage: { label: "Low Voltage", icon: Shield, color: "#06B6D4" },
  fire_alarm: { label: "Fire Alarm", icon: Shield, color: "#EF4444" },
  osha: { label: "OSHA", icon: Shield, color: "#22C55E" },
  continuing_education: { label: "CE Required", icon: GraduationCap, color: "#6366F1" },
  other: { label: "Other", icon: FileText, color: "#6B7280" },
};

export default function ElectricalLicensingScreen() {
  const router = useRouter();
  const [licenses, setLicenses] = useState<License[]>(mockElectricalLicenses);
  const [ceCourses] = useState<ContinuingEducation[]>(mockElectricalCE);
        ...
        { text: "Cancel", style: "cancel" },
        {
          ...
          onPress: () => {
            ...
            setLicenses((prev) =>
              prev.map((l) =>
                l.id === license.id
                  ? { ...l, expirationDate: newExpDate.toISOString().split("T")[0] }
                  : l
              )
            );
            setSelectedLicense((prev) =>
              prev?.id === license.id
                ? { ...prev, expirationDate: newExpDate.toISOString().split("T")[0] }
                : prev
            );
            Alert.alert("Updated", "License expiration date has been updated.");
          },
        },
        {
          text: "Update CE Credits",
          onPress: () => {
            const newCredits = (license.ceCreditsCompleted || 0) + 4;
            setLicenses((prev) =>
              prev.map((l) =>
                l.id === license.id
                  ? { ...l, ceCreditsCompleted: newCredits }
                  : l
              )
            );
            setSelectedLicense((prev) =>
              prev?.id === license.id
                ? { ...prev, ceCreditsCompleted: newCredits }
                : prev
            );
            Alert.alert("Updated", `CE credits updated to ${newCredits}.`);
          },
        },
      ]
    );
  ...
  const getTypeConfig = (type: CertificationType) => {
    return electricalTypeConfig[type] || electricalTypeConfig.other;
  };

  const renderLicenseCard = (license: License) => {
    const status = statusConfig[license.status];
    const type = getTypeConfig(license.type);
      ...
      >
              ...
              <View
                style={[
                  styles.ceProgressFill,
                  {
                    ...
                    backgroundColor: (license.ceCreditsCompleted || 0) >= license.ceCreditsRequired ? "#22C55E" : "#EAB308",
                  },
                ]}
              />
            </View>
        ...
        <View style={styles.cardActions}>
          <TouchableOpacity style={styles.viewButton} onPress={() => setSelectedLicense(license)}>
            ...
            <Text style={[styles.viewButtonText, { color: "#EAB308" }]}>View Details</Text>
          </TouchableOpacity>
          {(license.status === "expired" || isExpiringSoon) && (
            <TouchableOpacity
    ...
    <View style={styles.container}>
      ...
      <ScrollView style={styles.scrollView} showsVerticalScrollIndicator={false}>
        ...
        <View style={styles.tabsContainer}>
          ...
          >
            <Award size={18} color={activeTab === "licenses" ? "#EAB308" : Colors.textSecondary} />
          ...
          >
            <GraduationCap size={18} color={activeTab === "education" ? "#EAB308" : Colors.textSecondary} />
        ...
        {activeTab === "education" && (
          <View style={styles.educationSection}>
            ...
            <TouchableOpacity style={styles.addCourseButton}>
              ...
              <Text style={[styles.addCourseText, { color: "#EAB308" }]}>Add CE Course</Text>
            </TouchableOpacity>
          </View>
        )}
          ...
          <SafeAreaView style={styles.modalContainer}>
            ...
            <ScrollView style={styles.modalContent}>
              <View style={styles.modalLicenseHeader}>
                <View style={[styles.modalTypeIcon, { backgroundColor: `${getTypeConfig(selectedLicense.type).color}15` }]}>
                  {React.createElement(getTypeConfig(selectedLicense.type).icon, {
                    size: 32,
                    color: getTypeConfig(selectedLicense.type).color,
                  })}
                </View>
                      ...
                      <View
                        style={[
                          styles.ceDetailProgressFill,
                          {
                            ...
                            backgroundColor: (selectedLicense.ceCreditsCompleted || 0) >= selectedLicense.ceCreditsRequired ? "#22C55E" : "#EAB308",
                          },
                        ]}
                      />
                    </View>
              ...
              <View style={styles.modalActions}>
                <TouchableOpacity style={styles.editButton} onPress={() => handleEditLicense(selectedLicense)}>
                  <Edit3 size={18} color="#EAB308" />
                  <Text style={[styles.editButtonText, { color: "#EAB308" }]}>Edit License</Text>
                </TouchableOpacity>
